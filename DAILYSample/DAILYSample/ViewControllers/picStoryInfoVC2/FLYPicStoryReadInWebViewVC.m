...
@implementation FLYPicStoryReadInWebViewVC
...
- (void)viewDidLoad
{
    ...
    _webView = [[UIWebView alloc] initWithFrame:Rect(0, 0, 320, self.view.frame.size.height )];
    
    [self.view addSubview:_webView];
    _webView.scrollView.delegate = self;
    _webView.delegate = self;
    
    _webBarView = [[FLYWebBarView alloc] initWithFrame:Rect(0, self.view.frame.size.height - 44, 320, 44)];
